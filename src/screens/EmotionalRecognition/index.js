        ...
        <View style={styles.headerContainer}>
          <Image
            ...
            source={this.getImage(
              questions[this.state.indexQuestion].image,
              this.state.onTheLevel
            )}
          />
      ...
      return (
        <EtAnimation
          ...
          texts={[
            ...
            {
              text:
                'Preciso de ajuda pra entender as emoções que os humanos possuem',
            },
            { text: 'Vamos lá!' },
          ]}
        />
      ...
      return (
        <EtAnimation
          ...
          texts={[
            {
              text:
                'Olá, meus irmãos me contaram que você está sempre pronto a ajudar quando é preciso',
            },
