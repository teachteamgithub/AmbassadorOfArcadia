                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.levelButton}>
                            <PressButtonAnimationComponent
                                ...
                                width={300 * .6}
                                height={200 * .6}
                                actionPress={this.state.levelOne === 3 ? this.showToast.bind(this) : Actions.presentation.bind(this)} />
                        ...
                        <View style={styles.levelButton}>
                            <PressButtonAnimationComponent
                                ...
                                width={300 * .6}
                                height={200 * .6}
                                actionPress={this.state.levelTwo === 3 ? this.showToast.bind(this) : Actions.emotionalRecognition.bind(this)} />
