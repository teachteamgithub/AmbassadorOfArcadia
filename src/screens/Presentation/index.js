...
import { ImageBackground, View, Text, AsyncStorage, Alert } from 'react-native';
  ...
  getPresentationQuestions() {
    ...
    let level = [
      ...
      },
      {
        id: 3,
        question:
          'Como você descreveria a cor dos seus olhos para outra criança?',
        options: [
          {
            id: 1,
      ...
      return (
        <EtAnimation
          ...
          texts={[
            ...
            {
              text:
                'Você pode me ajudar a entender qual a melhor forma de me apresentar para elas?',
            },
            { text: 'Vamos lá!' },
          ]}
        />
      ...
      return (
        <EtAnimation
          ...
          texts={[
            ...
            {
              text:
                'Meu irmão me contou que você ajudou ele a conhecer novos amigos',
            },
            {
              text:
                'Eu também não sei como me apresentar para as outras pessoas',
            },
      ...
      <View>
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            {this.state.level[this.state.indexQuestion].question}
          </Text>
        </View>
        <View style={styles.optionsContainer}>
          {this.showOptions(
            this.state.level[this.state.indexQuestion].options
          ).map(option => (
            <Button
              key={option.id}
              text={option.text}
